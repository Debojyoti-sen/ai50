...
def load_data(directory):
    ...
    """
    # Load people
    with open(f"F:\courses\edx\code\large/people.csv", encoding="utf-8") as f:
    ...
    # Load movies
    with open(f"F:\courses\edx\code\large/movies.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            movies[row["id"]] = {
                "title": row["title"],
    ...
    # Load stars
    with open(f"F:\courses\edx\code\large/stars.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            try:
